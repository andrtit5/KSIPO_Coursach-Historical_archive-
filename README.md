...
Примечание
Некоторые UI-компоненты упрощены (заглушки для CRUD-операций). Архитектурные паттерны (Repository, DI, EF Core, валидация) полностью реализованы в коде и могут быть активированы раскомментированием соответствующих строк в Program.cs.
